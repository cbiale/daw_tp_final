...
{ 
    ...
    { 
      ...
      // botones de filtro
      let btnTodos:HTMLElement = this.myf.getElementById("botonTodos");
      let btnLamparas:HTMLElement = this.myf.getElementById("botonLamparas");
      let btnPersianas:HTMLElement = this.myf.getElementById("botonPersianas");

      // manejadores
      btnTodos.addEventListener("click",this);   
      btnLamparas.addEventListener("click",this);
      btnPersianas.addEventListener("click",this);
