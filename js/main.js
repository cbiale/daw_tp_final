...
class Main {
    ...
    main() {
        ...
        // botones de filtro
        let btnTodos = this.myf.getElementById("botonTodos");
        let btnLamparas = this.myf.getElementById("botonLamparas");
        let btnPersianas = this.myf.getElementById("botonPersianas");
        // manejadores
